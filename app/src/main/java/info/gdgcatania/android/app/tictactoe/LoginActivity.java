...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor>{
    ...
    protected void onPlusClientSignIn() {
        ...
        if(mPlusClient.getCurrentPerson()!=null) {
            String name = mPlusClient.getCurrentPerson().getName().getGivenName()+" "+mPlusClient.getCurrentPerson().getName().getFamilyName();
            disconnectButton.setText(name);

        } else{
            Log.wtf(TAG,"Person is NULL!!");
        }
        signOutButton.setText(email);

        Log.i(TAG,"mail: "+email);
        Log.i(TAG,"nome:");

        // TODO tirare il nome
        Utils.currentUser=new TTTUser(email,"nome");

        // TODO registare sul backend
        ...
        mRegIntent.putExtra(Utils.INTENT_TYPE, Utils.TYPE_REGISTER);
